...
namespace Maticsoft.Common
{
	...
	public class PageValidate
	{
        ...
        private static Regex RegPhone = new Regex("^\\(0\\d{2}\\)[- ]?\\d{8}$|^0\\d{2}[- ]?\\d{8}$|^\\(0\\d{3}\\)[- ]?\\d{7}$|^0\\d{3}[- ]?\\d{7}$|^0\\d{3}[- ]?\\d{8}$");
        private static Regex RegMobile = new Regex("^13\\d{9}$|^15\\d{9}$|^18\\d{9}$");
